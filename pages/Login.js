...
import CT from '../src/components/ComponentTest';
import CTForwardingRefs from '../src/components/ComponentTestForwardingRefs';
import UseRenderProps from '../src/components/UseRenderProps';
import RenderProps from '../src/components/RenderProps';
import Link from 'next/link'

import {connect} from "react-redux";
import * as actions from "../src/redux_config/actions";
...
class Login extends Component {
    ...
    componentDidMount() {
        ...
        let target = new Date("2019-09-30 17:00");
        let dis = parseInt((target.getTime() - current.getTime())/1000);
        setInterval(()=> {
            this.setState({time:dis});
            dis--;
        },1000)
    }
